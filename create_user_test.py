...
def test2_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("АнатолийАнатоли")
...
def test4_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("АнатолийАнатолий")

def test5_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("Qанатолий")

def test6_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Анатолий")

def test7_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Ана толий")

def test8_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("!@#")

def test9_create_user_has_number_in_first_name_get_error_response():
...
def test11_create_user_empty_first_name_get_error_response():
    # В переменную user_body сохраняется обновлённое тело запроса
    user_body = get_user_body("")
    # Проверка полученного ответа
    negative_assert_no_first_name(user_body)

def test12_create_user_number_type_first_name_get_error_response():
